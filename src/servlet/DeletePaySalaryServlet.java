 ...
 * @author 10303
 */
@WebServlet(name = "DeletePaySalaryServlet", urlPatterns = {"/DeletePaySalaryServlet"})
public class DeletePaySalaryServlet extends HttpServlet {
    ...
    public void del(int id) {
        try {
            PaySalaryService paySalaryService = new PaySalaryService();
            paySalaryService.delete(id);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
