 ...
 * @author 10303
 */
@WebServlet(name = "DeleteRepairCardServlet", urlPatterns = {"/DeleteRepairCardServlet"})
public class DeleteRepairCardServlet extends HttpServlet {
